...
configure_wordpress_and_plugin() {
  ...
  # activate the plugin
  wp --allow-root plugin activate wp-graphql-buddypress

  # Flush the permalinks
  wp --allow-root rewrite flush --hard

  # Export sql data for Codeception's use
  wp --allow-root db export /usr/src/wordpress/wp-content/plugins/wp-graphql-buddypress/tests/_data/dump.sql
